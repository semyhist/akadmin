...
const AdminPanel = () => {
        ...
        const admins = ['Aydın', 'Azra', 'Melih', 'Nisa', 'Taha', 'Yağız', 'Yankı', 'Yunus', 'Nehir', 'Furkan', 'Gencer', 'Nil'];
        const actions = [
        ...
        return ( <
                ...
                Card.Body > {
                    ...
                    controlId = "adminSelect" >
                    <
                    Form.Label > Admin Seç < /Form.Label> <
                    InputGroup >
                    <
                    InputGroup.Text > < FaUser / > < /InputGroup.Text> <
                    Form.Select value = { selectedAdmin }
                    onChange = { e => setSelectedAdmin(e.target.value) }
                    className = "form-select-custom" >
                    <
                    option value = "" > Seçiniz... < /option> {
                    admins.map(admin => < option key = { admin }
                        ...
                        <
                        option value = "" > Seçiniz... < /option> {
                        actions.map(action => < option key = { action.name }
                            value = { action.name } > { `${action.name} (${action.points})` } < /option>)} < /
                            Form.Select > <
                            /InputGroup> < /
                            Form.Group >
